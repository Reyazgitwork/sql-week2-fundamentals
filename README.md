...
- GROUP BY & HAVING
- INNER JOIN & LEFT JOIN
- Subqueries (IN, nested aggregates)
- Common Table Expressions (CTE)
- Window functions (ROW_NUMBER, RANK, DENSE_RANK)
- Revenue and trend analysis using relational datasets
...
## 🟢 Day 4 – Subqueries
- Subqueries in WHERE
- Nested aggregate comparisons
- IN operator usage
- Derived table workaround for MySQL LIMIT
...
- Why CTE improves readability
- Differences between ROW_NUMBER, RANK, and DENSE_RANK
- How SQL supports data-driven business decisions
